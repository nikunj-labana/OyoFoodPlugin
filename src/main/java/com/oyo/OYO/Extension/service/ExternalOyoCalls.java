...
public class ExternalOyoCalls {
    ...
    private OrderRequestOYO CreateOrderRequest(Transaction transaction, ProductDetails productDetails) {
        ...
        for (Product product : productDetails.getResponse()) {
            ...
            Double amount = Double.parseDouble(product.getProduct_sum())/ Currency.INR.getMultiplicationFactor();
